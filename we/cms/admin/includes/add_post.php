...
if(isset($_POST['create_post'])){
    ...
    $query .= "VALUES('{$post_id}','{$post_category_id}','{$post_title}','{$post_author}',now(),'{$post_image}','{$post_content}','{$post_tags}','{$post_comment_count}','{$post_status}' )";
...
?>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
       <input class="btn btn-primary" type="submit" name="create_post" value="Public Post">
